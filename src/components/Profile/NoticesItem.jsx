...
const NoticesItem = ({ data }) => {
  ...
  //         <Button className="w-full py-[13px] md:py-[12px] rounded-[30px] bg-orange-main text-[14px] md:text-[16px] leading-[129%] md:leading-[125%] text-white">
  //           Learn more
  //         </Button>
  //         <Button className="rounded-full bg-[#fff4df] min-w-[44px] h-[44px] flex justify-center items-center">
