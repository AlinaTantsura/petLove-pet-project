    ...
    <div className="bg-white rounded-[16px] p-6 md:p-[14px] md:pb-[18px]">
      ...
      <div>
        ...
        <div className="flex gap-[10px]">
          ...
          <Button onClick={()=>setOpen(true)} className="w-full py-[13px] md:py-[12px] rounded-[30px] bg-orange-main text-[14px] md:text-[16px] leading-[129%] md:leading-[125%] text-white">
            Learn more
          </Button>
          <Button onClick={() => setIdToRemove(data._id)} className={clsx("rounded-full bg-[#fff4df] min-w-[44px] h-[44px] flex justify-center items-center",
            isViewed && "hidden"
          )}>
        ...
        <ModalNotice onClose={() => setOpen(false)} open={open} data={data} setDeleteId={setIdToRemove} isFavorite={true} />
    </div>
  );
};
